...
void do_it_for_int () {
  ...
  if (myfile.is_open())
      ...
      while ( getline (myfile,line) )
	{
	  ...
	  ss >> x >> y >> z;
	  int absolute_value_2D = calculate_absolute_value<int>(x,y);
	  int absolute_value_3D = calculate_absolute_value<int>(x,y,z);
...
void do_it_for_float () {
  ...
  if (myfile.is_open())
      ...
      while ( getline (myfile,line) )
	{
	  ...
	  std:: stringstream ss(line);
	  ss >> x >> y >> z;
	  float absolute_value_2D= calculate_absolute_value<float>(x,y);
	  float absolute_value_3D= calculate_absolute_value<float>(x,y,z);
