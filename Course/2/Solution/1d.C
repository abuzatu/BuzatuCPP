...
// Solution. 
//map.begin() gets the first element
//map.end() is gets the one after the last, so we need to remove one to get the last element
//and as they are ordered, that is the solution
...
int main () {
  ...
  std::cout<<" "<<std::endl;
  std::cout<<"Printing from the map_mass_name the first and last elements, meaning already in the order of the mass of the planets"<<std::endl;
  iter_double_string=map_mass_name.begin();
  std::cout<<"first "<<std::endl;
  std::cout<<iter_double_string->first<<" "<<iter_double_string->second<<std::endl;
  iter_double_string=map_mass_name.end();
  iter_double_string--;
  ...
  std::cout<<" "<<std::endl;
  std::cout<<"Printing from the map_distance_name the first and last elements, meaning already in the order of the distance of the planets"<<std::endl;
  iter_double_string=map_distance_name.begin();
  std::cout<<"first "<<std::endl;
  std::cout<<iter_double_string->first<<" "<<iter_double_string->second<<std::endl;
  iter_double_string=map_distance_name.end();
  iter_double_string--;
  std::cout<<"last "<<std::endl;
  std::cout<<iter_double_string->first<<" "<<iter_double_string->second<<std::endl;
