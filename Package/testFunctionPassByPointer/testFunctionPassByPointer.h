#ifndef testFunctionPassByPointer_h
#define testFunctionPassByPointer_h
...
//function takes the variable a of type double by pointer
...
//but if we pass by pointer, we can change the original value in the function
